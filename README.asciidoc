...
IMPORTANT: For demonstration purpose, a Growl Handler was used but is not yet available as a GitHub or Packagist version.
Source code is provided in `extra` folder.
...
The monolog version used a https://github.com/Seldaek/monolog/pull/411[filter feature]
that is not yet included in Monolog distribution.

If you want to have a look on filter capability, add at least in your `composer.json` the following lines :

[source,json]
----
    "require": {
        "monolog/monolog": "dev-FilterFeature as 1.10"
    },
    "repositories": [
        {
            "type": "vcs",
            "url": "https://github.com/llaville/monolog"
        }
    ]
----
...
[source,bash]
----
$ php phpunit-4.2.2.phar -c /home/github/phpunit-LoggerTestListener/examples/phpunit.xml
----
...
----
[2014-08-26 10:48:40] PHPUnit.NOTICE: TestSuite 'Demo Test Suite' started. [] []
[2014-08-26 10:48:40] PHPUnit.NOTICE: TestSuite 'Your\Name_Space\YourTestSuite' started. [] []
[2014-08-26 10:48:40] PHPUnit.INFO: Test 'testIncomplete' started. [] []
[2014-08-26 10:48:40] PHPUnit.WARNING: Test 'testIncomplete' is incomplete. [] []
[2014-08-26 10:48:40] PHPUnit.INFO: Test 'testIncomplete' ended. [] []
[2014-08-26 10:48:40] PHPUnit.INFO: Test 'testFailure' started. [] []
[2014-08-26 10:48:40] PHPUnit.ERROR: Test 'testFailure' failed. [] []
[2014-08-26 10:48:41] PHPUnit.INFO: Test 'testFailure' ended. [] []
[2014-08-26 10:48:41] PHPUnit.NOTICE: TestSuite 'Your\Name_Space\YourTestSuite' ended. [] []
[2014-08-26 10:48:41] PHPUnit.NOTICE: TestSuite 'Demo Test Suite' ended. Tests: 2, Assertions: 2, Failures: 1, Incompleted: 1 [] []
----
